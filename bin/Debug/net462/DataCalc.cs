...
namespace Queryabl
{
    ...
    public static class DataCalc
    {
        ...
        /// <code>
        /// var ienum_mixed = new List<object>{ 103,"vffsd","fmos",new List<string>{"gfdfs","fsd","3489"},9.0,89.3m,99.42m,1,90000000000};
        /// var ienum_nums = ienum_mixed.FilterNumerics(); // Retrieved values of uint,decimal,double,int,long etc..
        /// </code>
        /// </example>
        ...
        /// <code>
        /// IQueryable<object> alldata = new List<object> { 103, "vffsd", "fmos", new List<string> { "gfdfs", "fsd", "3489" }, 9.0, 89.3m, 99.42m, 1, 90000000000 }.AsQueryable();
        ...
        /// // .Where(n => (n is Double) && ((double)n >= 1)); //select only doubles
        /// </code>
        /// </example>
        ...
        /// <code>
        /// var test_list = new List<List<int>>{new List<int>{1,3,4,4},
        /// new List<int>{43,54,32},
        ///						  new List<int>{99,10,403,10,20,10},
        ///						  new List<int>{1},
        ///						  new List<int>{90,40} }.AsQueryable();
        ///						  
        ...
        /// <code>
        /// IQueryable<string> hamCheckStr = new List<string>{"test1","test2","test3","test2","10times49","20times46","times"}.AsQueryable();
        /// var sourceStrings = new List<string> { "abc", "def", "xyz" }.AsQueryable();
        ///
        /// sourceStrings.WhereDist<string>("abg",1);
        /// sourceStrings.WhereDist<string>("aee",2);
        /// hamCheckStr.WhereDist<string>("test3",1); // all return the appropriate filtered queryable search results.
        /// </code>
        /// </example>
        ...
        /// 
        /// IQueryable<object> Freq1 = new List<object> { "gtes", 11, 15, 15, anim3, anim2, dog2, dog2, dog2, dog2, dog1, per4, per4, per1, per2, per3, 190, 190, 190, "vdvd", "3489" }.AsQueryable();
        /// 
        ...
        /// var per3 = new Person("john", "test");
        /// 
        /// IQueryable<int> testFreqOcc = new List<int>{1,5,5,6,7,7,7,7,72,2,1,4,6,11,11,11,11,11,88,88,7,34,43,5,88,61,14,23,11,100}.AsQueryable();
        /// IQueryable<string> freqSeq2 = new List<string> { "gg", "4334", "4334", "4554", "gg", "gg", "gg", "9000" }.AsQueryable();
        /// IQueryable<object> Freq1 = new List<object> { "gtes", 11, 15, 15, anim3, anim2, dog2, dog2, dog2, dog2, dog1, per4, per4, per1, per2, per3, 190, 190, 190, "vdvd", "3489" }.AsQueryable();
        /// 
